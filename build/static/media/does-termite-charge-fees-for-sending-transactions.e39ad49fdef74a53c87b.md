# Does Termite charge fees for sending transactions?
...
These transaction fees do not pass through Termite but paid by the user directly to the network when executing transactions.