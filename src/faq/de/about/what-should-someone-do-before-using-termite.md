# What should someone do before using Termite?

Before doing anything on Termite you're strongly encouraged to go over the Academy section and get familiar with essential aspects of cryptocurrency and DeFi ecosystem.
...
Apart from Academy, users are recommended to go over Termite terms (Settings > About section) and make sure they understand what Termite wallet is and risks involved in using the app.
